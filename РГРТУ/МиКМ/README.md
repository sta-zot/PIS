...
**Агрегативная система** представляет собой систему базирующуюся на агрегативных моделях, называемых агрегатами. Эти агрегаты могут выполнять различные функции в системе и иметь разные характеристики.
